...
class AIAssistant:
    ...
    def setup_paper_tab(self):
        ...
        search_status_label.grid(row=0, column=3, padx=5, pady=5, sticky="w")
        ...
        # 添加取消按钮（默认禁用）
        self.cancel_search_button = ttk.Button(buttons_frame, text="取消搜索", command=self.cancel_search, state="disabled")
